...
export const ItemsBarTop = styled.span`
    ...
    justify-content:${props => props.item ? 'center' : 'center'};
    width:${props => props.item ? '8.0rem ' : '0 auto'};
...
//     background:${props => props.bar ? '#D9D9D9' : 'transparent'};
//     font-size:${props => props.bar ? '1.8rem' : '2.4rem'};
//     left:${props => props.bar ? '50%' : '50%'};
//     top:${props => props.bar ? '34.0rem' : '80%'};
//     border-radius:${props => props.bar ? '3.9rem' : 'none'};
//     padding:${props => props.bar ? '1.0rem ' : '0'};
//     color:${props => props.bar ? '#656565' : '#FFF'};
//     transform:translate(-50%,-50%);
...
//     height: 5.0rem;
//     top: 68.0rem;
//     background:${props => props.ContentItems ? 'unset' : '#565555'};
//     &:nth-of-type(odd){
//         background:#D9D9D9;
//     }
...
//     display:${props => props.item ? 'flex' : 'flex'};
//     align-items:${props => props.item ? 'center' : 'center'};
//     width:${props => props.item ? '10.0rem' : 'auto'};
//     flex-wrap:${props => props.item ? 'wrap' : 'wrap'};
//     text-transform:${props => props.item ? 'uppercase' : 'uppercase'};
